...
main_img_data:
    ...
    size: "2000x1090"
    caption: "Detalj sa <a href='https://krcadinac.com/bantustan-interactive-atlas/mapa/namibia/' target='_blank'>mape Namibije</a>, <em>Bantustan Interaktivni atlas</em>, 2022."
lead: "Esej napisan povodom prve samostalne izložbe grafika iz Bantustana."
lead_short: "Esej napisan povodom prve samostalne izložbe grafika iz Bantustana"
content:
    - type: "txt"
    ...
    - type: "img"
      ...
      img_data:
        - file_name: "interface1_2.jpg"
          ...
          size3: "1940x1100"
          size: "1817x939"
          caption: "<a href='https://krcadinac.com/bantustan-interactive-atlas/' target='_blank'><em>Bantustan Interaktivni atlas</em></a>, interfejs digitalnog tumača, 2022."
    - type: "txt"
    ...
    <p>Ovo putovanje, rekao sam sebi, veće je od mene. Kao što je svet iz kojeg sam se rodio veći od mene. Treba makar da pokušam da ga skiciram.</p>"
    - type: "img"
      grid_rules: "grid-template-columns: 1fr;"
      img_data:
    ...
    <p>Iako geografski verodostojne i matematički precizne, sve ove mape su pre svega mape mitova i simbola. Kao kod Pirija Reisa i el Idirisija. Tu su legende u oba smisla: kao 1) mitovi, priče; i kao 2) kartografski tumači za simbole, rečnici u dnu karte.</p>
    ...
    <p class='heading1'>Kapitalistan</p>
    ...
    <p>Ovaj čovek bez čula, usamljeni solipsistički čovek zarobljen u samom sebi, zarobljen samim sobom – jesmo li to svi danas? Za stanovnike globalnog potrošačkog individualistana, pitanje mene – mojih interesa, moje slobode, mog užitka – jedino je legitimno pitanje. Kako je rekla Ajn Rand? »Neću ja da umrem, nego će svet prestati da postoji.« Zato je pitanje dodira ključno pitanje »Bantustana« – kako probiti ego-čauru, kako otputovati iz svoje glave? Kako dotaći svet?</p>
    ...
    <p>»Nakon što se završi kojsanski obred«, rekla nam je Zelda iz Namibije, »šamani crtaju.« Da li su to puki psihodelični tripovi? »Nisu to halucinacije«, rekla je. »Te tačke i linije, to su tlocrti viših stanja svesti, nevidljivi putokazi. Mape spajanja.«<sup id='s25'>25</sup></p>
...
sidenotes:
    ...
    - id: 11
      html: "<em><a href='http://monumenttotransformation.org/atlas-of-transformation/html/b/balkans/social-change-in-the-balkans-rastko-mocnik.html' target='_blank'>Social change in the Balkans</a></em>, R. Močnik, Eurozine, 2003."
    - id: 12
